...
#include <stdint.h>
#include "driver/spi_master.h" // This includes spi_device_handle_t

#define RFID_PIN_MISO 6
#define RFID_PIN_MOSI 18
#define RFID_PIN_CLK  3
#define RFID_PIN_CS   8

#define RFID_PIN_RST  1
