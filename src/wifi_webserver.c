...
"                        <div>Value 1: <span id=\"nrf-value-1\" class=\"data-value\">--</span></div>\n"
"                        <div>Value 2: <span id=\"nrf-value-2\" class=\"data-value\">--</span></div>\n"
"                        <div>Value 3: <span id=\"nrf-value-3\" class=\"data-value\">--</span></div>\n"
"                    </div>\n"
...
"                    document.getElementById('rfid-update-time').textContent = new Date().toLocaleTimeString();\n"
"                })\n"
"                .catch(error => {\n"
